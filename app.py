...
[매우 중요: 톤앤매너 및 포맷 엄수 규칙 (ABSOLUTE CRITICAL)]
...
6. [자막 슬래시 포맷 및 (비포애프터) 위치별 격리 규칙 (매우 중요)]:
...
7. [마크다운 강조(**) 금지 및 30자 초과 시 강제 줄바꿈]:
