...
2. [장면 설명 분할 줄바꿈 규칙 (매우 중요)]:
- **[### [X. 장면]] 아래의 촬영 컷 연출 설명은 절대 한 줄로 길게 쓰지 마세요.**
...
6. [캡션 및 해시태그 줄바꿈 규칙 (매우 중요)]:
- **[#광고 캡션] 영역은 문장마다 반드시 엔터를 쳐서 여러 줄로 나누어 작성하세요.** 한 문단으로 뭉쳐 쓰는 것 절대 금지.
- **[해시태그] 영역은 복수개의 해시태그가 있을 때 반드시 각 해시태그마다 엔터를 쳐서 세로로 한 줄씩 아래로 나열**하세요.
